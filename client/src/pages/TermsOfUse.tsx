      ...
      <div className="page-body privacy-policy-body">
        ...
        <div className="privacy-section">
          ...
          <div className="privacy-card">
            <p>{isZH
              ? '欢迎使用 PaperPhoneLite（以下简称"本应用"），由 FM619 Technolog LTD（以下简称"我们"）提供。注册或使用本应用即表示您同意遵守本使用条款。如果您不同意这些条款，请不要注册或使用本应用。'
              : 'Welcome to PaperPhoneLite (the "App"), provided by FM619 Technolog LTD ("we", "us", or "our"). By registering for or using the App, you agree to be bound by these Terms of Use. If you do not agree to these terms, please do not register for or use the App.'}</p>
          </div>
        </div>
        ...
        <div className="privacy-section">
          ...
          <div className="privacy-card highlight">
            <p style={{ fontWeight: 600 }}>{isZH
              ? 'PaperPhoneLite 对以下行为实行零容忍政策：'
              : 'PaperPhoneLite maintains a zero tolerance policy for the following:'}</p>
            <ul>
        ...
        <div className="privacy-section">
          ...
          <div className="privacy-card">
            <p>{isZH ? '作为 PaperPhoneLite 的用户，您同意：' : 'As a user of PaperPhoneLite, you agree to:'}</p>
            <ul>
