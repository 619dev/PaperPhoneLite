export const ko: Record<string, string> = {
  'app.name': 'PaperPhoneLite', 'auth.login': '로그인', 'auth.register': '회원가입',
  ...
  "chat.presentation_startup_password_prompt": "텍스트 모양 암호화 비밀번호를 입력하세요",
  "chat.presentation_startup_wrong_password": "비밀번호가 올바르지 않아 텍스트 모양을 복호화할 수 없습니다.",
