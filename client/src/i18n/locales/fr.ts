export const fr: Record<string, string> = {
  'app.name': 'PaperPhoneLite', 'auth.login': 'Connexion', 'auth.register': 'Inscription',
  ...
  'chat.uploading_image': 'Envoi de l\'image...', 'chat.uploading_video': 'Envoi de la vidéo...', 'chat.uploading_file': 'Envoi du fichier...', 'chat.uploading_voice': 'Envoi du message vocal...', 'chat.upload_failed': 'Échec de l\'envoi', 'chat.download_failed': 'Échec du téléchargement',
  ...
  'proxy.tor_required_notice': "Le client doit accéder au service .onion via Tor. En Chine continentale, activez d’abord un proxy compatible avec Tor. Les préréglages SOCKS5 127.0.0.1:7890 et 127.0.0.1:10808 sont fournis.",
  ...
  "chat.presentation_startup_password_prompt": "Saisissez le mot de passe de chiffrement de l’apparence du texte",
  "chat.presentation_startup_wrong_password": "Mot de passe incorrect. Impossible de déchiffrer l’apparence du texte.",
