export const es: Record<string, string> = {
  'app.name': 'PaperPhoneLite', 'auth.login': 'Iniciar Sesión', 'auth.register': 'Registrarse',
  ...
  'chat.uploading_image': 'Subiendo imagen...', 'chat.uploading_video': 'Subiendo vídeo...', 'chat.uploading_file': 'Subiendo archivo...', 'chat.uploading_voice': 'Subiendo nota de voz...', 'chat.upload_failed': 'Error al subir', 'chat.download_failed': 'Error al descargar',
  ...
  "chat.presentation_startup_password_prompt": "Introduce la contraseña de cifrado de la apariencia del texto",
  "chat.presentation_startup_wrong_password": "Contraseña incorrecta. No se puede descifrar la apariencia del texto.",
